                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                <a href="/nieuws/create">
                                    <button type="button" class="btn btn-primary add-new"><i class="fa fa-plus"></i>Voeg
                                        nieuwe</button>
                                </a>
                            </div>
                        </div>
                        ...
                        <tbody>
                            @foreach ($news as $item)
                                <tr>
                                    ...
                                    <td><a href="/nieuws/{{ $item->slug }}">Bekijk</a></td>
                                    <td>
                    ...
                    @foreach ($news as $item)
                            ...
                            <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="editModalLabel{{ $item->id }}">Bewerk nieuwsbericht</h5>
                                        ...
                                        <form action="{{ route('news.update', $item->id) }}" method="POST">
                                            ...
                                            <div class="form-row">
                                                <div class="form-group col-md-6">
                                                  ...
                                                  <input type="text" disabled class="form-control" id="title" name="title" value="{{ $item->user }}">
                                                </div>
                                                <div class="form-group col-md-6">
                                                  <label for="inputPassword4">URL</label>
                                                  <input type="text" disabled class="form-control" id="title" name="title" value="/nieuws/{{ $item->slug }}">
                                                </div>
                                              </div>
                        ...
                        <div class="modal fade" id="deleteModal{{ $item->id }}" tabindex="-1" role="dialog" aria-labelledby="deleteModalLabel{{ $item->id }}" aria-hidden="true">
                            <div class="modal-dialog  modal-dialog-centered" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="deleteModalLabel{{ $item->id }}">Verwijderen bevestigen</h5>
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                            <span aria-hidden="true">&times;</span>
                                        </button>
                                    </div>
                                    <div class="modal-body">
                                        ...
                                        <h4>{{$item->title }}</h4> <br> <span>{{nl2br(e($item->description))}}</span>
                                    </div>
